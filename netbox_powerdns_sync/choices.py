...
class NamingIpChoices(ChoiceSet):
    ...
    CHOICES = [
        ...
        (
            "netbox_powerdns_sync.naming.NamingIpReverse",
            "Use PTR format for IP (without arpa domain)",
        ),
    ]
...
class NamingDeviceChoices(ChoiceSet):
    ...
    CHOICES = [
        ...
        (
            "netbox_powerdns_sync.naming.NamingDeviceByInterface",
            "Use interface.device format",
        ),
        (
            "netbox_powerdns_sync.naming.NamingDeviceByInterfacePrimary",
            "Use interface.device format and device only for primary IP",
        ),
    ]
